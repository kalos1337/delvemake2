...
// IWYU pragma: private, include "ChunkMaster.h"
...
public: \
	DECLARE_CLASS(AChunkMaster, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/delvemake2"), NO_API) \
...
private: \
	...
	NO_API AChunkMaster(const AChunkMaster&); \
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AChunkMaster); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AChunkMaster); \
	DEFINE_DEFAULT_CONSTRUCTOR_CALL(AChunkMaster) \
...
template<> DELVEMAKE2_API UClass* StaticClass<class AChunkMaster>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_delvemake2_Source_delvemake2_Public_ChunkMaster_h
